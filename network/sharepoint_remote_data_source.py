...
USERNAME = env.get('sharepoint_email')
PASSWORD = env.get('sharepoint_password')
SHAREPOINT_SITE = env.get('sharepoint_url_site')
SHAREPOINT_SITE_NAME = env.get('sharepoint_site_name')
SHAREPOINT_DOC = env.get('sharepoint_doc_library')


class SharePointRemoteDataSource:
    @staticmethod
    def _auth():
