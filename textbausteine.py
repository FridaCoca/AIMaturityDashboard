...
# --- descriptions ---
tech_description = """ Um das volle Potenzial von KI zu erschöpfen, ist eine gute IT-Infrastruktur und –Technologie unumgänglich. Insbesondere geht es hier um kritische Hardware-und Softwareentscheidungen. """
daten_description = """KI lebt von den Daten, die ihr zur Verfügung gestellt werden und nehmen so eine entscheidende Rolle in der Entwicklung von KI ein. Im Vordergrund steht hierbei nicht nur die Verfügbarkeit von Daten, sondern auch deren Qualität. Eine gut definierte Dateninfrastruktur, die den Zugriff auf Daten und die Gewinnung von Kennzahlen aus Daten erleichtert, ist also eine zentrale Voraussetzung für effiziente KI.  """
processes_description = """Innerhalb eines KI-Projektes stellen sowohl die Identifikation von KI Einsatzfeldern, als auch die saubere Umsetzung des Vorhabens eine besondere Herausforderung dar. Hier steht deshalb ein transparenter und gut etablierter Prozess, der Innovations-, und Entwicklungs –und Integrationsprozesse unterstützt und so Ideen in praktikable Lösungen umwandelt, im Vordergrund. """
orga_description = """Um die Handlungsfähigkeit eines Unternehmens in Bezug auf KI einzuschätzen, ist es zentral den Status Quo hinsichtlich bereits vorliegender Expertise als auch der aktuellen Strategie, festzustellen.  """
# --- levels ---
